    ...
    <div class="flex justify-center items-center h-auto">
        <div class="bg-[#1F2937] w-[80%] sm:w-[50%] mt-10 p-5 flex-col rounded-md">
            ...
            <div class="text-gray-700 grid grid-cols-1 sm:flex">
                ...
                {{-- Cover --}}
                <div class="overflow-hidden bg-[#1F2937] text-gray-700 shadow-lg m-0 min-h-[300px] sm:max-w-[250px] sm:min-h-[300px] mb-5 sm:mb-0">
                    <img src="https://bucket.material-tailwind.com/magic-ai/06b38f84f9669f766048c469ce861b81880378273a11ae9badaedfc32868ef44.jpg" alt="Revolutionizing Our Production Process" class="object-cover w-full h-full rounded-md"/>
                </div>
                ...
                <div class="sm:pr-6 sm:pl-4 sm:ms-4 flex flex-col justify-center">
                    ...
                    <p class="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-white mb-2 normal-case">Videogame title</p>
                    <p class="block antialiased font-sans leading-relaxed mb-8 font-normal text-gray-500">Learn how our recent investment in new technology has revolutionized our production process, leading to improved efficiency and product quality.</p>
            ...
            <div class="flex flex-col mt-8 gap-6">
                <div class="px-10">
                    <div class="bg-none max-w-xl">
                        <div>
                            <h1 class="text-lg font-semibold text-white">Comment Title</h1>
