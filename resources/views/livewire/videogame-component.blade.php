    ...
    <div class="p-8">
        ...
        <div class="grid grid-cols-5 2xl:grid-cols-6 gap-8 gap-x-px justify-items-center">  
            ...
            <div>
                <div>
                    <!-- Centering wrapper -->
                    <div class="relative flex flex-col text-white bg-[#3f3fb7] shadow-md bg-clip-border rounded-xl w-60">
                        ...
                        <div class="mx-4 overflow-hidden text-white bg-[#3f3fb7] bg-clip-border rounded-xl h-60 w-52">
                            <img
