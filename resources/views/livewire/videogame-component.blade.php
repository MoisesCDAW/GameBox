                ...
                <div class="w-full">
                    <div class="m-8 my-20 max-w-[400px] mx-auto">
                            <div class="mb-8">
                                ...
                                <input type="text" wire:model="title" name="title" placeholder="Super Mario Bros." class="w-full p-3 bg-[#222d3d] text-white rounded-lg mt-2 placeholder:text-sm">
                                @error('title') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                <br><br>

                                {{-- Cover --}}
                                <span class="text-white text-sm">Game cover (optional)</span>
                                <input type="file" wire:model="cover" name="cover" class="w-full p-3 bg-none text-white rounded-lg text-sm">
